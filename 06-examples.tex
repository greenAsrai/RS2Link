...
P_T & \defeq & P(T,\widetilde{T})& \overline{P}_T & \defeq & P(\overline{T},\widetilde{T}) & P_{T'}& \defeq & P(T',\widetilde{T'}) & \overline{P}_{T',\widetilde{T'}}& \defeq & P(\overline{T'},\widetilde{T'})\\\
\end{array}
\]
