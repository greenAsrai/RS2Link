...
\[
\begin{array}{lclcl}
\llbracket ss \rrbracket& \defeq& P_{ss}&\defeq &\startchain{\tilde{ss}_i}\chainedlink{\widehat{s}_i}{\noact}\chainedlink{\noact}{\widehat{s}_o}\chainend{\tilde{ss}_o}.P_{ss}+
...
%\[
%\begin{array}{lcllcl}
&&\overline{P_{ss}}&\defeq &\startchain{{\color{red}\tilde{ss}_i}}\chainedlink{{\color{red}\widehat{s}_i}}{{\color{blue}\noact}}\chainedlink{{\color{blue}\noact}}{{\color{red}\widehat{s}_o}}\chainend{{\color{red}\tilde{ss}_o}}.P_{ss}
+
\startchain{dss_i}\chainend{dss_o}.\overline{P_{ss}}\\
