...
We only consider $Cxt_s^n$ with $n >0$, as the entities $s$ that are present at step zero  are considered to be present in the initial system (process $P_s$ instead of $\overline{P_s}$).
