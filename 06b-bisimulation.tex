...
$\zeta'$ is the set of  strings composed by characters in the set ${\cal C}$.
...
%The round brackets $(\zeta')$ build a single string  $\zeta'$, i.e. a non-separable sequence of characters.
